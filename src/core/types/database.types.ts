 ...
 */
export type DemandeUpdate = Partial<Omit<Demande, 'Dem_Id'>> & { Dem_Id: number };

/**
 * Types des utilisateurs
 */
export type User = Demandeur | Gestionnaire | Decideur | ValideurUnite | Administrateur;

/**
 * Rôles utilisateur
 */
export type UserRole = 'Demandeur' | 'Gestionnaire' | 'Decideur' | 'ValideurUnite' | 'Administrateur';
